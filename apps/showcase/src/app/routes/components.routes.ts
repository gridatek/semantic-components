...
export const componentsRoutes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: 'Select On Focus - Semantic Components',
        loadComponent: () =>
          import('../pages/docs/select-on-focus/select-on-focus-page'),
      },
      {
        path: 'autocomplete',
      ...
      {
        path: 'multiselect',
        title: 'Multiselect - Semantic Components',
        loadComponent: () =>
          import('../pages/docs/multiselect/multiselect-page'),
      },
      {
        path: 'navbar',
        title: 'Navbar - Semantic Components',
        loadComponent: () => import('../pages/docs/navbar/navbar-page'),
      },
      {
        path: 'native-dialog',
      ...
      {
        path: 'attachment',
        title: 'Attachment - Semantic Components',
