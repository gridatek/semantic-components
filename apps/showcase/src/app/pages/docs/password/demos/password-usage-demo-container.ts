...
import { PasswordUsageDemo } from './password-usage-demo';

@Component({
  selector: 'app-password-usage-demo-container',
  imports: [
    ScCodeViewer,
    ScCodeViewerHeader,
    ScCodeViewerLabel,
...
export class PasswordUsageDemoContainer {
