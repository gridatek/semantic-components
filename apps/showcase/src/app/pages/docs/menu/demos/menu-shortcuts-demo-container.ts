      ...
      <div scMenuPortal>
        <div scMenu class="w-56">
          ...
          <div scMenuItem value="Keyboard shortcuts">
            <svg siKeyboardIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
          ...
          <div scMenuSubProvider>
            <div scMenuSubTrigger value="Invite users">
              <svg siUserPlusIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
            ...
            <div scMenuSubPortal>
              <div scMenuSub>
                <div scMenuItem value="Email">
                  <svg siMailIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
                  <span class="flex-1">Email</span>
                </div>
                <div scMenuItem value="Message">
                  <svg siMessageSquareIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
          ...
          <div scMenuItem value="GitHub">
            <svg siGithubIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
            <span class="flex-1">GitHub</span>
          </div>
          <div scMenuItem value="Support">
            <svg siLifeBuoyIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
            <span class="flex-1">Support</span>
          </div>
          <div scMenuSeparator></div>
          <div scMenuItem value="Log out">
            <svg siLogOutIcon class="text-muted-foreground size-4" aria-hidden="true"></svg>
