...
import { FormFieldTagInputDemo } from './form-field-tag-input-demo';

@Component({
  selector: 'app-form-field-tag-input-demo-container',
  imports: [DemoContainer, FormFieldTagInputDemo],
  template: `
    <app-demo-container title="Form Field" [code]="code">
      <app-form-field-tag-input-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
