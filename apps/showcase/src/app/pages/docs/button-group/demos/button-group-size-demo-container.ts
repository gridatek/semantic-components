...
@Component({
  selector: 'app-button-group-size-demo-container',
  imports: [DemoContainer, ButtonGroupSizeDemo],
  encapsulation: ViewEncapsulation.None,
  template: `
    <app-demo-container
      title="Size"
      demoUrl="/demos/button-group/button-group-size-demo"
      [code]="code"
    >
      <app-button-group-size-demo />
    </app-demo-container>
  `,
