...
import { IconsSplitButtonDemo } from './icons-split-button-demo';

@Component({
  selector: 'app-icons-split-button-demo-container',
  imports: [DemoContainer, IconsSplitButtonDemo],
  template: `
    <app-demo-container title="With Icons" [code]="code">
      <app-icons-split-button-demo />
    </app-demo-container>
  `,
  host: { class: 'block' },
...
export class IconsSplitButtonDemoContainer {
