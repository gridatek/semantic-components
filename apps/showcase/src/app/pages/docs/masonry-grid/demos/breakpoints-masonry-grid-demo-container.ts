...
import { BreakpointsMasonryGridDemo } from './breakpoints-masonry-grid-demo';

@Component({
  selector: 'app-breakpoints-masonry-grid-demo-container',
  imports: [DemoContainer, BreakpointsMasonryGridDemo],
  template: `
    <app-demo-container title="Breakpoints" [code]="code">
