...
import { SignalFormsProgressDemo } from './signal-forms-progress-demo';

@Component({
  selector: 'app-signal-forms-progress-demo-container',
  imports: [DemoContainer, SignalFormsProgressDemo],
  template: `
    <app-demo-container
      title="Form Completion Progress"
      demoUrl="/demos/progress/signal-forms-progress-demo"
      [code]="code"
    >
