...
import { SizesButtonDemo } from './sizes-button-demo';

@Component({
  selector: 'app-sizes-button-demo-container',
  imports: [DemoContainer, SizesButtonDemo],
  template: `
    <app-demo-container
      title="Sizes"
      demoUrl="/demos/button/sizes-button-demo"
      [code]="code"
    >
