...
import { FormMentionInputDemo } from './form-mention-input-demo';

@Component({
  selector: 'app-form-mention-input-demo-container',
  imports: [DemoContainer, FormMentionInputDemo],
  template: `
    <app-demo-container title="Comment Form" [code]="code">
...
export class FormMentionInputDemoContainer {
