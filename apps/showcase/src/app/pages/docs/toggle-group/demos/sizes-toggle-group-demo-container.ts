...
@Component({
  ...
  template: \`
    <div class="flex flex-col gap-4">
      <div scToggleGroup type="single" size="sm" aria-label="Small toggle group">
      ...
      <div scToggleGroup type="single" size="default" aria-label="Default toggle group">
        <button scToggleGroupItem value="a" aria-label="Option A">A</button>
        <button scToggleGroupItem value="b" aria-label="Option B">B</button>
        <button scToggleGroupItem value="c" aria-label="Option C">C</button>
      </div>
      <div scToggleGroup type="single" size="lg" aria-label="Large toggle group">
        <button scToggleGroupItem value="a" aria-label="Option A">A</button>
        <button scToggleGroupItem value="b" aria-label="Option B">B</button>
        <button scToggleGroupItem value="c" aria-label="Option C">C</button>
      </div>
