...
import { OutlineToggleGroupDemo } from './outline-toggle-group-demo';

@Component({
  selector: 'app-outline-toggle-group-demo-container',
  imports: [DemoContainer, OutlineToggleGroupDemo],
  template: `
    <app-demo-container title="Outline" [code]="code">
