...
import { FormFieldTagsInputDemo } from './form-field-tags-input-demo';

@Component({
  selector: 'app-form-field-tags-input-demo-container',
  imports: [DemoContainer, FormFieldTagsInputDemo],
  template: `
    <app-demo-container title="Form Field" [code]="code">
      <app-form-field-tags-input-demo />
    </app-demo-container>
  `,
...
export class FormFieldTagsInputDemoContainer {
