...
import { DuplicatesTagsInputDemo } from './duplicates-tags-input-demo';

@Component({
  selector: 'app-duplicates-tags-input-demo-container',
  imports: [DemoContainer, DuplicatesTagsInputDemo],
  template: `
    <app-demo-container title="Allow Duplicates" [code]="code">
      <app-duplicates-tags-input-demo />
    </app-demo-container>
  `,
...
export class DuplicatesTagsInputDemoContainer {
