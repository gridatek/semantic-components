...
@Component({
  ...
  template: `
    <div ngCombobox readonly>
      <div
        #origin
        class="flex items-center relative border rounded-lg px-3 h-10 cursor-pointer"
      >
      ...
      <ng-template ngComboboxPopupContainer>
        ...
        >
          <div
            class="bg-popover text-popover-foreground mt-1 rounded-lg border p-1 shadow-md max-h-44"
          >
