        ...
        <div scSelectPopup>
          <div scSelectList>
            ...
            <div scSelectGroup>
              ...
              <div scSelectItem value="Carrot" label="Carrot">Carrot<svg scSelectItemIndicator siCheckIcon></svg></div>
              <div scSelectItem value="Broccoli" label="Broccoli">Broccoli<svg scSelectItemIndicator siCheckIcon></svg></div>
              <div scSelectItem value="Spinach" label="Spinach">Spinach<svg scSelectItemIndicator siCheckIcon></svg></div>
            </div>
          </div>
        </div>
      </ng-template>
