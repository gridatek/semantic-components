...
import { PopoverTimePickerDemo } from './popover-time-picker-demo';

@Component({
  selector: 'app-popover-time-picker-demo-container',
  imports: [DemoContainer, PopoverTimePickerDemo],
  template: `
...
export class PopoverTimePickerDemoContainer {
