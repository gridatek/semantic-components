...
import { GridLayoutSizing } from './grid-layout-sizing';

@Component({
  selector: 'app-grid-layout-sizing-section',
  imports: [GridLayoutSizing, PreviewCodeTabs],
  template: `
    <app-preview-code-tabs [code]="code" [title]="title()" [level]="level()">
      <app-grid-layout-sizing />
...
export class GridLayoutSizingSection {
  readonly title = input<string>('Grid Sizing Options');
    ...
    <div class="space-y-8 w-full">
      ...
      <div>
        ...
        <div sc-grid-layout cols="2" rowSizing="auto" gap="4">
          ...
          <div class="bg-red-100 dark:bg-red-900 rounded-lg p-4 text-center min-h-[120px] flex items-center">
