...
import { TouchAreaDemo } from './touch-area-demo';

@Component({
  selector: 'app-touch-area-demo-section',
  imports: [TouchAreaDemo, PreviewCodeTabs],
  template: `
...
export class TouchAreaDemoSection {
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-2 text-sm">
          <li class="flex items-center justify-between">
            ...
            <div class="relative">
              <a href="#" class="text-xs text-blue-600 hover:underline">Edit</a>
              <span sc-touch-area></span>
            </div>
          </li>
          <li class="flex items-center justify-between">
