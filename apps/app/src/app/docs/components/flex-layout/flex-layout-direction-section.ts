...
import { FlexLayoutDirection } from './flex-layout-direction';

@Component({
  selector: 'app-flex-layout-direction-section',
  imports: [FlexLayoutDirection, PreviewCodeTabs],
  template: `
    <app-preview-code-tabs [code]="code" [title]="title()" [level]="level()">
      <app-flex-layout-direction />
...
export class FlexLayoutDirectionSection {
  readonly title = input<string>('Flex Direction');
