...
import { NewTabsDemo } from './new-tabs-demo';

@Component({
  selector: 'app-new-tabs-demo-section',
  imports: [NewTabsDemo, PreviewCodeTabs],
  template: `
...
export class NewTabsDemoSection {
...
@Component({
  ...
  template: \`
    <div class="w-[400px]" scNewTabs>
      <div class="grid w-full grid-cols-2" scNewTabList [selectedTab]="'account'">
