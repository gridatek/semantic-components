...
@Component({
  selector: 'app-time-picker-with-seconds-demo-section',
  imports: [PreviewCodeTabs, TimePickerWithSecondsDemo],
  template: `
...
export class TimePickerWithSecondsDemoSection {
  readonly title = input<string>('With seconds');
