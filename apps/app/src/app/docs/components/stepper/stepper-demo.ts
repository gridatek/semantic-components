      ...
      <sc-stepper (stepCompleteEvent)="onStepComplete()">
        <sc-step label="Account Setup">
          <div class="space-y-4">
            ...
            <p class="text-gray-600">Let's start by setting up your account information.</p>
            <div class="space-y-3">
              <div>
        ...
        <sc-step label="Profile Details">
          <div class="space-y-4">
            ...
            <p class="text-gray-600">Add more details to help us personalize your experience.</p>
            <div class="space-y-3">
              <div>
        ...
        <sc-step label="Preferences">
          <div class="space-y-4">
            ...
            <p class="text-gray-600">Configure your account settings and notifications.</p>
            <div class="space-y-4">
              <div>
