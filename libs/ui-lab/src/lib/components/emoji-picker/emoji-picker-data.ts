...
export const DEFAULT_CATEGORIES: EmojiCategory[] = [
  {
    id: 'smileys',
  ...
  },
  {
    ...
    emojis: [
      ...
      },
      {
        emoji: '👍',
        name: 'thumbs up',
        keywords: ['like', 'yes', 'approve'],
      },
      { emoji: '👎', name: 'thumbs down', keywords: ['dislike', 'no'] },
      {
        emoji: '✊',
        name: 'raised fist',
        keywords: ['power', 'punch'],
      },
      {
        emoji: '👊',
        name: 'oncoming fist',
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🏉', name: 'rugby football', keywords: ['sport'] },
      {
        emoji: '🥏',
        name: 'flying disc',
        keywords: ['sport', 'frisbee'],
      },
      {
        emoji: '🎱',
        name: 'pool 8 ball',
        keywords: ['game', 'billiards'],
      },
      {
        emoji: '🏓',
        name: 'ping pong',
        keywords: ['sport', 'table tennis'],
      },
  ...
  },
  {
    ...
    emojis: [
      ...
      { emoji: '🏳️', name: 'white flag', keywords: ['surrender'] },
      {
        emoji: '🏳️‍🌈',
        name: 'rainbow flag',
        keywords: ['pride', 'lgbtq'],
      },
      {
        emoji: '🏴‍☠️',
        name: 'pirate flag',
        keywords: ['pirate', 'jolly roger'],
      },
      {
        emoji: '🇺🇸',
