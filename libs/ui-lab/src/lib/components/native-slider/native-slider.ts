...
export class ScNativeSlider {
  ...
  protected readonly class = computed(() =>
    cn(
      ...
      '[&::-webkit-slider-runnable-track]:h-2 [&::-webkit-slider-runnable-track]:rounded-full [&::-webkit-slider-runnable-track]:bg-[image:linear-gradient(to_right,var(--primary)_var(--fill-percent,0%),var(--secondary)_var(--fill-percent,0%))]',
      ...
      '[&::-webkit-slider-thumb]:size-5 [&::-webkit-slider-thumb]:-mt-1.5 [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-primary [&::-webkit-slider-thumb]:bg-background [&::-webkit-slider-thumb]:transition-shadow',
      '[&:hover::-webkit-slider-thumb]:shadow-[0_0_0_4px_oklch(from_var(--primary)_l_c_h/0.2)]',
      '[&::-moz-range-thumb]:size-5 [&::-moz-range-thumb]:appearance-none [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:border-2 [&::-moz-range-thumb]:border-primary [&::-moz-range-thumb]:bg-background [&::-moz-range-thumb]:transition-shadow',
      '[&:hover::-moz-range-thumb]:shadow-[0_0_0_4px_oklch(from_var(--primary)_l_c_h/0.2)]',
