    ...
    <div [class]="toolbarClass()">
      ...
      @if (config().showZoom) {
        <div class="flex items-center gap-1">
          <button
            ...
            title="Zoom out"
          >
            <svg siZoomOutIcon class="size-[18px]"></svg>
          </button>
          ...
          <button
            ...
            title="Zoom in"
          >
            <svg siZoomInIcon class="size-[18px]"></svg>
          </button>
        </div>
      }
      ...
      @if (config().showRotate) {
        <button
          ...
          title="Rotate left"
        >
          <svg siRotateCcwIcon class="size-[18px]"></svg>
        </button>
        ...
        <button
          ...
          title="Rotate right"
        >
          <svg siRotateCwIcon class="size-[18px]"></svg>
        </button>
      }
      ...
      @if (config().showPrint) {
        <button
          ...
          title="Print"
        >
          <svg siPrinterIcon class="size-[18px]"></svg>
        </button>
      }
      ...
      @if (config().showFullscreen) {
        ...
        >
          @if (isFullscreen()) {
            <svg siMinimizeIcon class="size-[18px]"></svg>
          } @else {
            <svg siMaximizeIcon class="size-[18px]"></svg>
          }
        </button>
      }
    </div>
