...
export class ScDialog {
  ...
  protected readonly class = computed(() =>
    cn(
      'relative mx-auto bg-background ring-foreground/10 grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-xl p-4 text-sm ring-1 duration-100 outline-none sm:max-w-sm',
      'data-idle:opacity-0',
