...
@Component({
  ...
  template: `
    <!-- Language Selector -->
    <div class="fixed top-4 right-4 z-50" *ngIf="showLanguageSelector">
    ...
    <div
      ...
      *ngIf="showConsent && !showPreferences"
      role="dialog"
        ...
        <div class="p-6">
          ...
          <div class="space-y-6">
            <div
              ...
              *ngFor="let category of cookieCategories"
            >
    ...
    <div class="min-h-screen bg-gray-50 flex items-center justify-center" *ngIf="!showConsent">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div class="space-y-2 text-left">
            <div
              ...
              *ngFor="let pref of getPreferencesArray()"
            >
