...
export class ScSwitchField implements ScSwitchContext {
  ...
  protected readonly class = computed(() =>
    cn(
      ...
      'has-[>[data-slot=field-description]]:*:data-[slot=label-text]:font-medium',
      ...
      'has-[>:first-child[data-slot=switch]]:*:data-[slot=label-text]:col-start-2 has-[>:first-child[data-slot=switch]]:*:data-[slot=label-text]:row-start-1',
      ...
      'has-[>:not(:first-child)[data-slot=switch]]:*:data-[slot=label-text]:col-start-1 has-[>:not(:first-child)[data-slot=switch]]:*:data-[slot=label-text]:row-start-1',
